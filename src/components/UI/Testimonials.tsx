        ...
        <figure className="max-w-screen-md mx-auto">
          ...
          <blockquote>
            <p className="text-2xl font-medium text-gray-900 dark:text-white">
              "WebAcademy is just awesome. It contains tons of courses and lectures ranging in categories and topics.
              Its the perfect place to start learning something new"
            </p>
          </blockquote>
