...
import {categoryItemInterface, categoryItemsInterface, categories} from "../../../helper/categoriesList";
...
const CategoriesItems: FC<CategoriesItemsProps> = (props) => {
    ...
    const topicMenu = (
        <>
            ...
            <MenuList>
                {topicsList?.map((topic) => <TopicsItem key={topic} topic={topic}/>)}
            </MenuList>
        </>
    );
        ...
        <Stack direction={"row"}>
            <MenuList>
                {categories.map((category): any =>
                    ...
                    <CategoriesItem onCategoryClick={onCategoryClickHandler} key={Object.keys(category)[0]}
