  ...
  return (
    <>
      <div className="absolute ml-32 mt-10 ">
        <h1 className="font-serif text-4xl font-semibold text-gray-800 dark:text-gray-200">Checkout</h1>
          ...
          <div className="flex flex-col mt-4">
            ...
            <div className="flex flex-row justify-between">
              <div className="flex flex-col my-2">
                <label htmlFor="securityCode" className="font-bold text-gray-600">
                  Security Code
                </label>
                <input
                  id="securityCode"
              ...
              <div className="flex flex-col my-2">
                <label htmlFor="expirationDate" className="font-bold text-gray-600">
                  Expiration Date
                </label>
                <input
                  id="expirationDate"
        ...
        <div className="bg-gray-100 pr-52 pb-48 flex flex-col items-center ">
          <div className="p-5 m-10 pt-14">
            <div className="w-60">
              ...
              <p className="text-xs mt-5">By completing your purchase you agree to these Terms of Service.</p>
              <button
                disabled={props.mutationIsLoading}
                onClick={onCompleteCheckoutClickHandler}
              ...
              w-full justify-center items-center font-medium focus:outline-none dark:bg-blue-700 dark:hover:bg-blue-600 bg-black
               hover:bg-slate-700 disabled:bg-slate-500"
              >
                Complete Checkout
              </button>
            </div>
